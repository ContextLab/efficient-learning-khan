...
%DIF ADD main.tex   Tue Oct 24 20:56:47 2023
...
distinguish between \DIFdelbegin \DIFdel{held-out correctly versus incorrectly answered }\DIFdelend \DIFaddbegin \DIFadd{correctly and incorrectly answered held-out }\DIFaddend questions
...
\DIFdelbegin \DIFdel{answers a question (}\DIFdelend \DIFaddbegin \DIFadd{correctly answered a question }\DIFaddend at embedding coordinate $x$\DIFdelbegin \DIFdel{) correctly}\DIFdelend . As we move \DIFaddbegin \DIFadd{farther }\DIFaddend away
from $x$ in the embedding space, how does \DIFdelbegin \DIFdel{their knowledge }\DIFdelend \DIFaddbegin \DIFadd{the likelihood that the participant knows about the content at a given location }\DIFaddend ``fall off'' with distance?
\DIFdelbegin \DIFdel{Or}\DIFdelend \DIFaddbegin \DIFadd{Conversely}\DIFaddend , suppose the participant instead answered that same question
\textit{in}correctly. Again, as we move \DIFaddbegin \DIFadd{farther }\DIFaddend away from $x$ in the embedding space,
how \DIFdelbegin \DIFdel{do the chances }\DIFdelend \DIFaddbegin \DIFadd{does the likelihood }\DIFaddend that the participant does \textit{not} know about \DIFdelbegin \DIFdel{the
}\DIFdelend \DIFaddbegin \DIFadd{a coordinate's
}\DIFaddend content change with distance? We reasoned that, assuming our \DIFaddbegin \DIFadd{embedding }\DIFaddend space is capturing
something about how \DIFdelbegin \DIFdel{participants }\DIFdelend \DIFaddbegin \DIFadd{individuals }\DIFaddend actually organize 
their knowledge, \DIFdelbegin \DIFdel{conceptual
...
the content at }\DIFdelend \DIFaddbegin \DIFadd{their 
ability to answer the question embedded }\textit{\DIFadd{at}} \DIFaddend $x$. \DIFdelbegin \DIFdel{And }\DIFdelend \DIFaddbegin \DIFadd{Whereas 
}\DIFaddend at another extreme, \DIFdelbegin \DIFdel{at some distance (after moving
sufficiently far away }\DIFdelend \DIFaddbegin \DIFadd{once we reach some sufficiently large 
distance }\DIFaddend from $x$\DIFdelbegin \DIFdel{), our guesses about what participants know
(}\DIFdelend \DIFaddbegin \DIFadd{, our ability to infer whether or not a participant 
will correctly answer a question }\DIFaddend based on their \DIFdelbegin \DIFdel{response to }\DIFdelend \DIFaddbegin \DIFadd{ability to answer 
}\DIFaddend the question at \DIFdelbegin \DIFdel{location }\DIFdelend $x$ \DIFdelbegin \DIFdel{) }\DIFdelend should be no better than guessing based on 
their \DIFdelbegin \DIFdel{overall }\DIFdelend \DIFaddbegin \textit{\DIFadd{overall}} \DIFaddend proportion of correctly answered questions\DIFdelbegin \DIFdel{—i.e., if $y$ is very far away from $x$, all we can do with the }\DIFdelend \DIFaddbegin \DIFadd{. In 
other words, beyond the maximum distance at which the }\DIFaddend participant's
 \DIFdelbegin \DIFdel{response to }\DIFdelend \DIFaddbegin \DIFadd{ability to answer the question at }\DIFaddend $x$ is \DIFdelbegin \DIFdel{guess that ``their performance on quiz
questions about }\DIFdelend \DIFaddbegin \DIFadd{informative of their ability to 
 answer a second question at location }\DIFaddend $y$\DIFdelbegin \DIFdel{will be about equal to their average performance on quiz
questions about any material.
''
}\DIFdelend \DIFaddbegin \DIFadd{, then guessing the outcome 
