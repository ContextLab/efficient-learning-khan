...
We carried out these analyses in three different ways. First, we used all of
...
from one lecture to predict knowledge at the embedding coordinate of a held-out
...
we used questions from one lecture to predict knowledge at the embedding
...
``forgotten'' knowledge that participants answered incorrectly.  Taken together,
the results in Figure~\ref{fig:predictions} indicate that our approach can
reliably predict acquired knowledge (especially about recently learned content),
and that the knowledge predictions are generalizable across the content areas
spanned by the two lectures and also specific enough to distinguish between
questions about different content within the same lecture.
