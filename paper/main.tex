...
do not seem to be structured in a meaningful way with respect to the embedding
...
%In each versions of this analysis (i.e., row in Fig.~\ref{fig:predictions}), and separately for each of the three quizzes (i.e., column in Fig.~\ref{fig:predictions}),  we then fit a generalized linear mixed model (GLMM) with a logistic link function to the set of 


%In the set of analyses reported in Figure~\ref{fig:predictions}, we used generalized linear mixed models (GLMMs) to analyze whether estimates of participants' knowledge at the embedding coordinates of individual held-out questions could reliably predict their ability to answer those questions correctly.
