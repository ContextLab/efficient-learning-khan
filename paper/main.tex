...
%(See \hyperref[subsec:experiment]{\textit{Experiment}} for more information on how these lectures were chosen.)
...
model (Fig.~\ref{fig:sliding-windows}A; see 
\hyperref[subsec:topic-modeling]{\textit{Constructing text embeddings of multiple lectures 
and questions}}). The ($k$=15) topics 


%To construct a corpus of text documents for the two lectures, we parsed their transcripts into overlapping sliding windows (Fig.~\ref{fig:sliding-windows}A; see \hyperref[subsec:topic-modeling]{\textit{Constructing text embeddings of multiple lectures and questions}})
