...
questions) between the lectures and questions.  [ADD BACK CORRELATION RESULTS]
...
We used the fitted topic model to transform the text of each question in our
stimulus pool into the same embedding space as the two lectures' trajectories
...
questions from each category (i.e., questions about lecture 1, lecture 2, and
...
correlations between each pair of topic-weight variance vectors (i.e., vectors
containing the variance across timepoints or questions, for each topic;
Fig.~\ref{fig:topics}B). 


We found that our model represented the contents of
