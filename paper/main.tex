...
grades can instead be used to obtain much more detailed insights into what the
...
that had participants answer sets multiple-choice questions about a series of
...
concepts, courses, and students. This requires that the conceptual content of
...
Sec.~\ref{subsec:traces}), we obtain a high-resolution snapshot (at the time
each quiz was taken) of what the participants knew about any moment's content,
from either of the two lectures they watched (comprising a total of 1,100
samples across the two lectures).
...
\begin{figure}[tp]
    ...
    topic vectors in the \textit{Four Fundamental Forces} (bluer coloring) and
    \textit{Birth of Stars} (greener coloring) videos, respectively.}
