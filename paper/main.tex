...
Transforming these windows with our model resulted in a number-of-windows by
...
space (whose axes are topics learned by the model). Within this space, each lecture's series of
...
content unfolds over time (Fig.~\ref{fig:sliding-windows}A). We resampled
...
Next, wondered whether we could use this same model to capture the 
