...
reflect related concepts (e.g., quiz questions that were ostensibly, by
...
%Figure~\ref{fig:topics} displays the variability in topic weights across timepoints in each lecture, and across questions in each category (i.e., lecture 1-related, lecture 2-related, and general physics knowledge).

We used our model to transformed the text of each question in our pool into
the same embedding space as the two lectures' trajectories (Fig
.~\ref{fig:sliding-windows}C). This yielded a single 15-dimensional
coordinate (i.e., topic vector) for each question. When we compared the
...
general physics knowledge), we found multiple interesting patterns. First,
