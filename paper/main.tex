...
\begin{abstract}\noindent Real-world conceptual knowledge is complex,
multifaceted, and substantially over-simplified in most laboratory studies.
Here we develop a mathematical framework, based on natural language processing
models, for tracking and characterizing the acquisition of real-world conceptual
knowledge. Our approach embeds each concept in a high-dimensional representation
space where nearby coordinates reflect similar or related concepts. We test our
approach using behavioral data from participants who answered small sets of
multiple-choice quiz questions interleaved between watching two Khan Academy
course videos. We apply our framework to the videos' transcripts and the text of
the quiz questions to quantify the content of each moment of video and each quiz
question. We use these embeddings, along with participants' quiz responses, to
track how the learners' knowledge changed after watching each video and predict
their success on individual quiz questions. Our findings show how a small set of
quiz questions may be used to obtain rich and meaningful insights into what each
learner knows, and how their knowledge changes over time as they learn.
\end{abstract}
...
know or how their knowledge changes over time with training. However, also 
unlike the approach we have taken here, these systems can respond to learners'
needs with concise, natural language feedback in real time. One could imagine 
building a hybrid system that combines the best of both worlds: a smaller model 
that can infer what learners know and how their knowledge changes over time, and 
a larger generative model that can translate those insights into concrete, 
actionable feedback and interventions. Such a hybrid system could potentially be
used to build the next generation of interactive tutoring systems that are able to adapt to learners'
needs in real time, and provide more nuanced feedback about what learners know
...
following~\cite{BoydEtal14}, such as removing corpus-specific stop-words, the
...
approaches suggested by~\cite{BoydEtal14}: ``actual,'' ``actually,'' ``also,''
...
from~\cite{BateEtal15b} and \cite{MatuEtal17}. Specifically, we initially fit
...
https://github.com/Con\-text\-Lab/eff\-ic\-ient-learn\-ing-khan and is archived 
on Zenodo at https://doi.org/\-10.5281/\-zenodo.17783435 \citep{FitzEtal25}.
...
and is archived on Zenodo at https://doi.org/\-10.5281/\-zenodo.17783435 \citep{FitzEtal25}.
...
\bibitem{BlayEtal06}
\bibinfo{author}{Blaye, A.}, \bibinfo{author}{Bernard-Peyron, V.},
  \bibinfo{author}{Paour, J.-L.} \& \bibinfo{author}{Bonthoux, F.}
\newblock \bibinfo{title}{Category flexibility in children: distinguishing
  response flexibility from conceptual flexibility; the protracted development
  of taxonomic representations}.
\newblock \emph{\bibinfo{journal}{{European} Journal of Developmental
  Psychology}} \textbf{\bibinfo{volume}{3}}, \bibinfo{pages}{163--188}
  (\bibinfo{year}{2006}).

\bibitem{CaraMaho03}
\bibinfo{author}{Caramazza, A.} \& \bibinfo{author}{Mahon, B.~Z.}
\newblock \bibinfo{title}{The organization of conceptual knowledge: the
  evidence from category-specific semantic deficits}.
\newblock \emph{\bibinfo{journal}{Trends in Cognitive Sciences}}
  \textbf{\bibinfo{volume}{7}}, \bibinfo{pages}{354--361}
  (\bibinfo{year}{2003}).
...
\bibitem{DeacEtal04}
\bibinfo{author}{Deacon, D.} \emph{et~al.}
\newblock \bibinfo{title}{Evidence for a new conceptualization of semantic
  representation in the left and right cerebral hemispheres}.
\newblock \emph{\bibinfo{journal}{Cortex}} \textbf{\bibinfo{volume}{40}},
  \bibinfo{pages}{467--478} (\bibinfo{year}{2004}).

\bibitem{SimoEtal04}
\bibinfo{author}{Simon, M.~A.}, \bibinfo{author}{Tzur, R.},
  \bibinfo{author}{Heinz, K.} \& \bibinfo{author}{Kinzel, M.}
\newblock \bibinfo{title}{Explicating a mechanism for conceptual learning:
  elaborating the construct of reflective abstraction}.
\newblock \emph{\bibinfo{journal}{Journal for Research in Mathematics
  Education}} \textbf{\bibinfo{volume}{35}}, \bibinfo{pages}{305--329}
  (\bibinfo{year}{2004}).

\bibitem{HuebWill18}
\bibinfo{author}{Huebner, P.~A.} \& \bibinfo{author}{Willits, J.~A.}
\newblock \bibinfo{title}{Structured semantic knowledge can emerge
  automatically from predicting word sequences in child-directed speech}.
\newblock \emph{\bibinfo{journal}{Frontiers in Psychology}}
  \textbf{\bibinfo{volume}{9}},
  \bibinfo{pages}{doi.org/10.3389/fpsyg.2018.00133} (\bibinfo{year}{2018}).

\bibitem{LeeChen22}
\bibinfo{author}{Lee, H.} \& \bibinfo{author}{Chen, J.}
\newblock \bibinfo{title}{Predicting memory from the network structure of
  naturalistic events}.
\newblock \emph{\bibinfo{journal}{Nature Communications}}
  \textbf{\bibinfo{volume}{13}},
  \bibinfo{pages}{doi.org/10.1038/s41467--022--31965--2}
  (\bibinfo{year}{2022}).

\bibitem{vanPEtal21}
\bibinfo{author}{{van Paridon}, J.}, \bibinfo{author}{Liu, Q.} \&
  \bibinfo{author}{Lupyan, G.}
\newblock \bibinfo{title}{How do blind people know that blue is cold?
  distributional semantics encode color-adjective associations}.
\newblock \emph{\bibinfo{journal}{Proceedings of the Annual Meeting of the
  Cognitive Science Society}} \textbf{\bibinfo{volume}{43}}
  (\bibinfo{year}{2021}).

\bibitem{Kint70}
\bibinfo{author}{Kintsch}.
\newblock \emph{\bibinfo{title}{Learning, memory, and conceptual processes}}
  (\bibinfo{publisher}{Wiley}, \bibinfo{year}{1970}).

\bibitem{Macl05}
\bibinfo{author}{Maclellan, E.}
\newblock \bibinfo{title}{Conceptual learning: the priority for higher
  education}.
\newblock \emph{\bibinfo{journal}{British Journal of Educational Studies}}
  \textbf{\bibinfo{volume}{53}}, \bibinfo{pages}{129--147}
  (\bibinfo{year}{2005}).

\bibitem{ScotEtal07}
\bibinfo{author}{Scott, P.}, \bibinfo{author}{Asoko, H.} \&
  \bibinfo{author}{Leach, J.}
\newblock \emph{\bibinfo{title}{Handbook of research on science education}},
  chap. \bibinfo{chapter}{Student conceptions and conceptual learning in
  science} (\bibinfo{publisher}{Routledge}, \bibinfo{year}{2007}).

\bibitem{TulcEtal23}
\bibinfo{author}{Tulchinskii, E.} \emph{et~al.}
\newblock \bibinfo{title}{Intrinsic dimension estimation for robust detection
  of {AI}-generated texts}.
\newblock \emph{\bibinfo{journal}{{arXiv}}}
  \textbf{\bibinfo{volume}{2306.04723}} (\bibinfo{year}{2023}).

\bibitem{Kato40}
\bibinfo{author}{Katona, G.}
\newblock \emph{\bibinfo{title}{Organizing and memorizing: studies in the
  psychology of learning and teaching}} (\bibinfo{publisher}{Columbia
  {University} Press}, \bibinfo{year}{1940}).

\bibitem{Gall00}
\bibinfo{author}{Gallagher, J.~J.}
\newblock \bibinfo{title}{Teaching for understanding and application of science
  knowledge}.
\newblock \emph{\bibinfo{journal}{School Science and Mathematics}}
  \textbf{\bibinfo{volume}{100}}, \bibinfo{pages}{310--318}
  (\bibinfo{year}{2000}).

\bibitem{HallGree08}
\bibinfo{author}{Hall, R.} \& \bibinfo{author}{Greeno, J.}
\newblock \emph{\bibinfo{title}{21st century education: A reference handbook}},
  chap. \bibinfo{chapter}{Conceptual learning}, \bibinfo{pages}{212--221}
  (\bibinfo{publisher}{Sage Publications}, \bibinfo{year}{2008}).
...
\bibitem{DeerEtal90}
\bibinfo{author}{Deerwester, S.}, \bibinfo{author}{Dumais, S.~T.},
  \bibinfo{author}{Furnas, G.~W.}, \bibinfo{author}{Landauer, T.~K.} \&
  \bibinfo{author}{Harshman, R.}
\newblock \bibinfo{title}{Indexing by latent semantic analysis}.
\newblock \emph{\bibinfo{journal}{Journal of the {American} Society for
  Information Science}} \textbf{\bibinfo{volume}{41}},
  \bibinfo{pages}{391--407} (\bibinfo{year}{1990}).
...
\newblock In \emph{\bibinfo{booktitle}{Proceedings of the International
  Conference on Machine Learning}}, \bibinfo{pages}{113--120}
  (\bibinfo{publisher}{Association for Computing Machinery},
  \bibinfo{address}{New York, {NY}}, \bibinfo{year}{2006}).
...
\newblock In \bibinfo{editor}{Kahana, M.~J.} \& \bibinfo{editor}{Wagner, A.~D.}
  ...
  (\bibinfo{publisher}{{Oxford} {University} Press}, \bibinfo{year}{2023}).
...
\newblock \emph{\bibinfo{journal}{Psychological Review}}
  \textbf{\bibinfo{volume}{128}}, \bibinfo{pages}{711--725}
  (\bibinfo{year}{2021}).

\bibitem{PianHill22}
\bibinfo{author}{Piantadosi, S.~T.} \& \bibinfo{author}{Hill, F.}
\newblock \bibinfo{title}{Meaning without reference in large language models}.
\newblock \emph{\bibinfo{journal}{{arXiv}}}
  \textbf{\bibinfo{volume}{2208.02957}} (\bibinfo{year}{2022}).

\bibitem{ReilEtal82}
\bibinfo{author}{Reilly, D.~L.}, \bibinfo{author}{Cooper, L.~N.} \&
  \bibinfo{author}{Elbaum, C.}
\newblock \bibinfo{title}{A neural model for category learning}.
\newblock \emph{\bibinfo{journal}{Biological Cybernetics}}
  \textbf{\bibinfo{volume}{45}}, \bibinfo{pages}{35--41}
  (\bibinfo{year}{1982}).

\bibitem{Este86a}
\bibinfo{author}{Estes, W.~K.}
\newblock \bibinfo{title}{Array models for category learning}.
\newblock \emph{\bibinfo{journal}{Cognitive Psychology}}
  \textbf{\bibinfo{volume}{18}}, \bibinfo{pages}{500--549}
  (\bibinfo{year}{1986}).

\bibitem{Este86b}
\bibinfo{author}{Estes, W.~K.}
\newblock \bibinfo{title}{Memory storage and retrieval processes in category
  learning}.
\newblock \emph{\bibinfo{journal}{Journal of Experimental Psychology: General}}
  \textbf{\bibinfo{volume}{115}}, \bibinfo{pages}{155--174}
  (\bibinfo{year}{1986}).

\bibitem{GlucEtal02}
\bibinfo{author}{Gluck, M.~A.}, \bibinfo{author}{Shohamy, D.} \&
  \bibinfo{author}{Myers, C.~E.}
\newblock \bibinfo{title}{How do people solve the ``weather prediction'' task?
  individual variability in strategies for probabilistic category learning}.
\newblock \emph{\bibinfo{journal}{Learning and Memory}}
  \textbf{\bibinfo{volume}{9}}, \bibinfo{pages}{408--418}
  (\bibinfo{year}{2002}).
...
\bibitem{HulbNorm15}
\bibinfo{author}{Hulbert, J.~C.} \& \bibinfo{author}{Norman, K.~A.}
\newblock \bibinfo{title}{Neural differentiation tracks improved recall of
  competing memories following interleaved study and retrieval practice}.
\newblock \emph{\bibinfo{journal}{Cerebral Cortex}}
  \textbf{\bibinfo{volume}{25}}, \bibinfo{pages}{3994--4008}
  (\bibinfo{year}{2015}).

\bibitem{Khan04}
\bibinfo{author}{Khan, S.}
\newblock \emph{\bibinfo{title}{The {K}han Academy}}
  (\bibinfo{publisher}{Salman Khan}, \bibinfo{year}{2004}).

\bibitem{HeusEtal21}
\bibinfo{author}{Heusser, A.~C.}, \bibinfo{author}{Fitzpatrick, P.~C.} \&
  \bibinfo{author}{Manning, J.~R.}
\newblock \bibinfo{title}{Geometric models reveal behavioral and neural
  signatures of transforming experiences into memories}.
\newblock \emph{\bibinfo{journal}{Nature Human Behaviour}}
  \textbf{\bibinfo{volume}{5}}, \bibinfo{pages}{905--919}
  (\bibinfo{year}{2021}).

\bibitem{Fish22}
\bibinfo{author}{Fisher, R.~A.}
\newblock \bibinfo{title}{On the mathematical foundations of theoretical
  statistics}.
\newblock \emph{\bibinfo{journal}{Philosophical Transactions of the Royal
  Society {A}}} \textbf{\bibinfo{volume}{222}}, \bibinfo{pages}{309--368}
  (\bibinfo{year}{1922}).
...
\newblock \emph{\bibinfo{journal}{{arXiv}}}
  \textbf{\bibinfo{volume}{1810.04805}} (\bibinfo{year}{2018}).

\bibitem{ChatGPT}
\bibinfo{author}{OpenAI}.
\newblock \bibinfo{title}{{ChatGPT}}.
\newblock \bibinfo{howpublished}{https://chat.openai.com}
  (\bibinfo{year}{2023}).

\bibitem{TouvEtal23}
\bibinfo{author}{Touvron, H.} \emph{et~al.}
\newblock \bibinfo{title}{{LLaMA}: open and efficient foundation language
  models}.
\newblock \emph{\bibinfo{journal}{{arXiv}}}
  \textbf{\bibinfo{volume}{2302.13971}} (\bibinfo{year}{2023}).

\bibitem{MannEtal23b}
\bibinfo{author}{Manning, J.~R.}, \bibinfo{author}{Menjunatha, H.} \&
  \bibinfo{author}{Kording, K.}
\newblock \bibinfo{title}{Chatify: {A} {J}upyter extension for adding
  {LLM}-driven chatbots to interactive notebooks}.
\newblock \bibinfo{howpublished}{\url{https://github.com/ContextLab/chatify}}
  (\bibinfo{year}{2023}).

\bibitem{MoseEtal21}
\bibinfo{author}{Moser, K.~M.}, \bibinfo{author}{Wei, T.} \&
  \bibinfo{author}{Brenner, D.}
\newblock \bibinfo{title}{Remote teaching during {COVID-19}: implications from
  a national survey of language educators}.
\newblock \emph{\bibinfo{journal}{System}} \textbf{\bibinfo{volume}{97}},
  \bibinfo{pages}{102431} (\bibinfo{year}{2021}).

\bibitem{ShimLee20}
\bibinfo{author}{Shim, T.~E.} \& \bibinfo{author}{Lee, S.~Y.}
\newblock \bibinfo{title}{College students' experience of emergency remote
  teaching during {COVID-19}}.
\newblock \emph{\bibinfo{journal}{Children and Youth Services Review}}
  \textbf{\bibinfo{volume}{119}}, \bibinfo{pages}{105578}
  (\bibinfo{year}{2020}).

\bibitem{KawaEtal21}
\bibinfo{author}{Kawasaki, H.} \emph{et~al.}
\newblock \bibinfo{title}{Remote teaching due to {COVID-19}: an exploration of
  its effectiveness and issues}.
\newblock \emph{\bibinfo{journal}{International Journal of Environmental
  Research and Public Health}} \textbf{\bibinfo{volume}{18}},
  \bibinfo{pages}{2672} (\bibinfo{year}{2021}).

\bibitem{Whal20}
\bibinfo{author}{Whalen, J.}
\newblock \bibinfo{title}{Should teachers be trained in emergency remote
  teaching? {L}essons learned from the {COVID-19} pandemic}.
\newblock \emph{\bibinfo{journal}{Journal of Technology and Teacher Education}}
  \textbf{\bibinfo{volume}{28}}, \bibinfo{pages}{189--199}
  (\bibinfo{year}{2020}).

\bibitem{Youn12}
\bibinfo{author}{Young, J.~R.}
\newblock \bibinfo{title}{Inside the {C}oursera contract: how an upstart
  company might profit from free courses}.
\newblock \emph{\bibinfo{journal}{The Chronicle of Higher Education}}
  \textbf{\bibinfo{volume}{19}}, \bibinfo{pages}{1--4} (\bibinfo{year}{2012}).

\bibitem{Kolo13}
\bibinfo{author}{Kolowich, S.}
\newblock \bibinfo{title}{How {EdX} plans to earn, and share, revenue from its
  free online courses}.
\newblock \emph{\bibinfo{journal}{The Chronicle of Higher Education}}
  \textbf{\bibinfo{volume}{21}}, \bibinfo{pages}{1--5} (\bibinfo{year}{2013}).

\bibitem{RhoaEtal13}
\bibinfo{author}{Rhoads, R.~A.}, \bibinfo{author}{Berdan, J.} \&
  \bibinfo{author}{Toven-Lindsey, B.}
\newblock \bibinfo{title}{The open courseware movement in higher education:
  unmasking power and raising questions about the movement's democratic
  potential}.
\newblock \emph{\bibinfo{journal}{Educational Theory}}
  \textbf{\bibinfo{volume}{63}}, \bibinfo{pages}{87--110}
  (\bibinfo{year}{2013}).

\bibitem{Kauf03}
\bibinfo{author}{Kaufman, D.~M.}
\newblock \bibinfo{title}{Applying educational theory in practice}.
\newblock \emph{\bibinfo{journal}{British Medical Journal}}
  \textbf{\bibinfo{volume}{326}}, \bibinfo{pages}{213--216}
  (\bibinfo{year}{2003}).

\bibitem{NastEtal20}
\bibinfo{author}{Nastase, S.~A.}, \bibinfo{author}{Goldstein, A.} \&
  \bibinfo{author}{Hasson, U.}
\newblock \bibinfo{title}{Keep it real: rethinking the primacy of experimental
  control in cognitive neuroscience}.
\newblock \emph{\bibinfo{journal}{{NeuroImage}}} \textbf{\bibinfo{volume}{15}},
  \bibinfo{pages}{117254--117261} (\bibinfo{year}{2020}).

\bibitem{NguyEtal22}
\bibinfo{author}{Nguyen, M.} \emph{et~al.}
\newblock \bibinfo{title}{Teacher-student neural coupling during teaching and
  learning}.
\newblock \emph{\bibinfo{journal}{Social Cognitive and Affective Neuroscience}}
  \textbf{\bibinfo{volume}{17}}, \bibinfo{pages}{367--376}
  (\bibinfo{year}{2022}).

\bibitem{MeshEtal20}
\bibinfo{author}{Meshulam, M.} \emph{et~al.}
\newblock \bibinfo{title}{Neural alignment predicts learning outcomes in
  students taking an introduction to computer science course}.
\newblock \emph{\bibinfo{journal}{Nature Communications}}
  \textbf{\bibinfo{volume}{12}},
  \bibinfo{pages}{doi.org/10.1038/s41467--021--22202--3}
  (\bibinfo{year}{2020}).

\bibitem{PoulEtal17}
\bibinfo{author}{Poulsen, A.~T.}, \bibinfo{author}{Kamronn, S.},
  \bibinfo{author}{Dmochowski, J.}, \bibinfo{author}{Parra, L.~C.} \&
  \bibinfo{author}{Hansen, L.~K.}
\newblock \bibinfo{title}{{EEG} in the classroom: synchronised neural
  recordings during video presentation}.
\newblock \emph{\bibinfo{journal}{Scientific Reports}}
  \textbf{\bibinfo{volume}{7}}, \bibinfo{pages}{43916} (\bibinfo{year}{2017}).

\bibitem{BeviEtal19}
\bibinfo{author}{Bevilacqua, D.}, \bibinfo{author}{Davidesco, I.},
  \bibinfo{author}{Wan, L.} \& \bibinfo{author}{Chaloner, K.}
\newblock \bibinfo{title}{Brain-to-brain synchrony and learning outcomes vary
  by student-teacher dynamics: evidence from a real-world classroom
  electroencephalography study}.
\newblock \emph{\bibinfo{journal}{Journal of Cognitive Neuroscience}}
  \textbf{\bibinfo{volume}{31}}, \bibinfo{pages}{401--411}
  (\bibinfo{year}{2019}).

\bibitem{DikkEtal17}
\bibinfo{author}{Dikker, S.} \emph{et~al.}
\newblock \bibinfo{title}{Brain-to-brain synchrony tracks real-world dynamic
  group interactions in the classroom}.
\newblock \emph{\bibinfo{journal}{Current Biology}}
  \textbf{\bibinfo{volume}{27}}, \bibinfo{pages}{1375--1380}
  (\bibinfo{year}{2017}).

\bibitem{GoldWinn12}
\bibinfo{author}{Goldstein, T.~R.} \& \bibinfo{author}{Winner, E.}
\newblock \bibinfo{title}{Enhancing empathy and theory of mind}.
\newblock \emph{\bibinfo{journal}{Journal of Cognition and Development}}
  \textbf{\bibinfo{volume}{13}}, \bibinfo{pages}{19--37}
  (\bibinfo{year}{2012}).

\bibitem{KansEtal15}
\bibinfo{author}{Kanske, P.}, \bibinfo{author}{B\"{o}ckler, A.} \&
  \bibinfo{author}{Singer, T.}
\newblock \bibinfo{title}{Models, mechanisms and moderators dissociating
  empathy and theory of mind}.
\newblock In \emph{\bibinfo{booktitle}{Social Behavior From Rodents to
  Humans}}, \bibinfo{pages}{193--206} (\bibinfo{publisher}{Springer},
  \bibinfo{year}{2015}).

\bibitem{Melt11}
\bibinfo{author}{Meltzoff, A.~N.}
\newblock \bibinfo{title}{Social cognition and the origins of imitation,
  empathy, and theory of mind}.
\newblock In \emph{\bibinfo{booktitle}{The Wiley-Blackwell Handbook of
  Childhood Cognitive Development}} (\bibinfo{publisher}{Wiley-Blackwell},
  \bibinfo{year}{2011}).

\bibitem{ShaoEtal18}
\bibinfo{author}{Shao, Y.~N.} \emph{et~al.}
\newblock \bibinfo{title}{Simulation-based empathy training improves the
  communication skills of neonatal nurses}.
\newblock \emph{\bibinfo{journal}{Clinical Simulation in Nursing}}
  \textbf{\bibinfo{volume}{22}}, \bibinfo{pages}{32--42}
  (\bibinfo{year}{2018}).

\bibitem{StepBaer06}
\bibinfo{author}{Stepien, K.~A.} \& \bibinfo{author}{Baernstein, A.}
\newblock \bibinfo{title}{Education for empathy}.
\newblock \emph{\bibinfo{journal}{Journal of General Internal Medicine}}
  \textbf{\bibinfo{volume}{21}}, \bibinfo{pages}{524--530}
  (\bibinfo{year}{2006}).

\bibitem{Ratk18}
\bibinfo{author}{Ratka, A.}
\newblock \bibinfo{title}{Empathy and the development of affective skills}.
\newblock \emph{\bibinfo{journal}{{American} Journal of Pharmaceutical
  Education}} \textbf{\bibinfo{volume}{82}},
  \bibinfo{pages}{doi.org/10.5688/ajpe7192} (\bibinfo{year}{2018}).

\bibitem{BoydEtal14}
\bibinfo{author}{Boyd-Graber, J.}, \bibinfo{author}{Mimno, D.} \&
  \bibinfo{author}{Newman, D.}
\newblock \bibinfo{title}{Care and feeding of topic models: problems,
  diagnostics, and improvements}.
\newblock In \bibinfo{editor}{Airoldi, E.~M.}, \bibinfo{editor}{Blei, D.~M.},
  \bibinfo{editor}{Erosheva, E.~A.} \& \bibinfo{editor}{Fienberg, S.~E.} (eds.)
  \emph{\bibinfo{booktitle}{Handbook of Mixed Membership Models and Their
  Applications}} (\bibinfo{publisher}{{CRC} Press}, \bibinfo{year}{2014}).

\bibitem{ZimaEtal18}
\bibinfo{author}{Ziman, K.}, \bibinfo{author}{Heusser, A.~C.},
  \bibinfo{author}{Fitzpatrick, P.~C.}, \bibinfo{author}{Field, C.~E.} \&
  \bibinfo{author}{Manning, J.~R.}
\newblock \bibinfo{title}{Is automatic speech-to-text transcription ready for
  use in psychological experiments?}
\newblock \emph{\bibinfo{journal}{Behavior Research Methods}}
  \textbf{\bibinfo{volume}{50}}, \bibinfo{pages}{2597--2605}
  (\bibinfo{year}{2018}).

\bibitem{Depo18}
\bibinfo{author}{Depoix, J.}
\newblock \bibinfo{title}{{YouTube} transcript {API}}.
\newblock
  \bibinfo{howpublished}{\url{https://github.com/jdepoix/youtube-transcript-api}}
  (\bibinfo{year}{2018}).

\bibitem{BirdEtal09}
\bibinfo{author}{Bird, S.}, \bibinfo{author}{Klein, E.} \&
  \bibinfo{author}{Loper, E.}
\newblock \emph{\bibinfo{title}{Nature language processing with {Python}:
  analyzing text with the natural language toolkit}}
  (\bibinfo{publisher}{Reilly Media, Inc.}, \bibinfo{year}{2009}).

\bibitem{BateEtal15a}
\bibinfo{author}{Bates, D.}, \bibinfo{author}{M{\"a}chler, M.},
  \bibinfo{author}{Bolker, B.} \& \bibinfo{author}{Walker, S.}
\newblock \bibinfo{title}{Fitting linear mixed-effects models using {lme4}}.
\newblock \emph{\bibinfo{journal}{Journal of Statistical Software}}
  \textbf{\bibinfo{volume}{67}}, \bibinfo{pages}{1--48} (\bibinfo{year}{2015}).

\bibitem{BateEtal15b}
\bibinfo{author}{Bates, D.}, \bibinfo{author}{Kliegl, R.},
  \bibinfo{author}{Vasishth, S.} \& \bibinfo{author}{Baayen, H.}
\newblock \bibinfo{title}{Parsimonious mixed models}.
\newblock \emph{\bibinfo{journal}{{arXiv}}}
  \textbf{\bibinfo{volume}{1506.04967}} (\bibinfo{year}{2015}).

\bibitem{MatuEtal17}
\bibinfo{author}{Matuschek, H.}, \bibinfo{author}{Kliegl, R.},
  \bibinfo{author}{Vasishth, S.}, \bibinfo{author}{Baayen, H.} \&
  \bibinfo{author}{Bates, D.}
\newblock \bibinfo{title}{Balancing type i error and power in linear mixed
  models}.
\newblock \emph{\bibinfo{journal}{Journal of Memory and Language}}
  \textbf{\bibinfo{volume}{94}}, \bibinfo{pages}{305--315}
  (\bibinfo{year}{2017}).

\bibitem{GoldSimo00}
\bibinfo{author}{Goldman, N.} \& \bibinfo{author}{Whelan, S.}
\newblock \bibinfo{title}{{Statistical Tests of Gamma-Distributed Rate
...
\newblock \emph{\bibinfo{journal}{Molecular Biology and Evolution}}
  \textbf{\bibinfo{volume}{17}}, \bibinfo{pages}{975--978}
  (\bibinfo{year}{2000}).

\bibitem{ScheEtal08b}
\bibinfo{author}{Scheipl, F.}, \bibinfo{author}{Greven, S.} \&
  \bibinfo{author}{K{\"u}chenhoff, H.}
\newblock \bibinfo{title}{Size and power of tests for a zero random effect
  variance or polynomial regression in additive and linear mixed models}.
\newblock \emph{\bibinfo{journal}{Computational Statistics \& Data Analysis}}
  \textbf{\bibinfo{volume}{52}}, \bibinfo{pages}{3283--3299}
  (\bibinfo{year}{2008}).

\bibitem{SnijBosk11}
\bibinfo{author}{Snijders, T. A.~B.} \& \bibinfo{author}{Bosker, R.}
\newblock \bibinfo{title}{More powerful tests for variance parameters}.
\newblock In \emph{\bibinfo{booktitle}{{Multilevel Analysis: An Introduction to
  Basic and Advanced Multilevel Modeling}}}, chap.~\bibinfo{chapter}{6},
  \bibinfo{pages}{94--108} (\bibinfo{publisher}{Sage Publications},
  \bibinfo{year}{2011}), \bibinfo{edition}{2nd} edn.

\bibitem{DaviHink97}
\bibinfo{author}{Davison, A.~C.} \& \bibinfo{author}{Hinkley, D.~V.}
\newblock \emph{\bibinfo{title}{Bootstrap Methods and their Application}}.
...
\bibitem{HaleHojs14}
\bibinfo{author}{Halekoh, U.} \& \bibinfo{author}{H{\o}jsgaard, S.}
\newblock \bibinfo{title}{{A Kenward-Roger Approximation and Parametric
  Bootstrap Methods for Tests in Linear Mixed Models -- The R Package
  pbkrtest}}.
\newblock \emph{\bibinfo{journal}{Journal of Statistical Software}}
  \textbf{\bibinfo{volume}{59}}, \bibinfo{pages}{1--32} (\bibinfo{year}{2014}).

\bibitem{McInEtal18a}
\bibinfo{author}{McInnes, L.}, \bibinfo{author}{Healy, J.} \&
  \bibinfo{author}{Melville, J.}
\newblock \bibinfo{title}{{UMAP}: {U}niform {m}anifold {a}pproximation and
...
\bibitem{McInEtal18b}
\bibinfo{author}{McInnes, L.}, \bibinfo{author}{Healy, J.},
  \bibinfo{author}{Saul, N.} \& \bibinfo{author}{Gro{\ss}berger, L.}
\newblock \bibinfo{title}{{UMAP}: {U}niform {M}anifold {A}pproximation and
  {P}rojection}.
\newblock \emph{\bibinfo{journal}{Journal of Open Source Software}}
  \textbf{\bibinfo{volume}{3}}, \bibinfo{pages}{861} (\bibinfo{year}{2018}).
  
\bibitem{FitzEtal25}
\bibinfo{author}{Fitzpatrick, P.~C.}, \bibinfo{author}{Heusser, A.~C.} \& 
  \bibinfo{author}{Manning, J.~R.}
\newblock \bibinfo{title}{Text embedding models yield detailed conceptual knowledge maps
  derived from short multiple-choice quizzes}.
\newblock {\em Zenodo}, \url{https://doi.org/10.5281/zenodo.17783435}. (2025).
