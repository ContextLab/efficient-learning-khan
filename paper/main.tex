...
contained in the two lectures. Aside from increasing the number of topics from
15 to 100, all other procedures and model parameters were carried over from the
...
responses (e.g., Fig.~\ref{fig:smoothness}). In other words, our study shows
that knowledge about a given concept implies knowledge about related concepts.
...
and last lines. These sliding windows ramped up and down in length at the
beginning and end of each transcript, respectively. In other words, each
transcript's first sliding window covered only its first line, the second
...
correlations) insures that every question contributes some non-negative amount
