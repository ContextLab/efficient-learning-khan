...
(Fig.~\ref{fig:predictions}) suggests that spatial relationships in the text
...
\textit{in}correctly. Again, as we move away from $x$ in the embedding space,
how do the chances that the participant does \textit{not} know about the
